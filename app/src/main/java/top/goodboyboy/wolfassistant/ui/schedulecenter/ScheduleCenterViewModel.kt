...
constructor(
    ...
    suspend fun setScheduleNotification() {
        if(loadScheduleState.value != LoadScheduleState.Success || loadLabScheduleState.value != LoadScheduleState.Success){
    ...
    init {
        viewModelScope.launch {
            ...
            globalEventBus.subscribeToTarget<SubmitScheduleNotification>(
                SCHEDULE_CENTER_TAG,
            ).collect {
